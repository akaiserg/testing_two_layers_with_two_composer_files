...
class InfoPersonTest extends PHPUnit_Framework_TestCase {
    ...
    public function checkInstance() {
        ...
        $sClassName='system\activity\activities\InfoPerson';
        $oInfoPerson= new  activities\InfoPerson(self::$oStoreFile);
        $this->assertInstanceOf($sInterfaceName,$oInfoPerson," The instance is not of ".$sInterfaceName);
        $this->assertInstanceOf($sClassName,$oInfoPerson," The instance is not of ".$sClassName);
